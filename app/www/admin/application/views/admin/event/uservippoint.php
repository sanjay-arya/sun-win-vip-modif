...
<!--                                    style="padding-left: 10px;">VP Được Add</span>-->
<!--                                <input type="checkbox" value="4"  name="chklist" id="filed_3"><span style="padding-left: 10px;">Số lần Add</span>-->
...
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Account:</label></td>-->
