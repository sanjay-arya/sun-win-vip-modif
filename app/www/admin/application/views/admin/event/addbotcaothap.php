...
<!--            <div class="col-sm-2"><input class="form-control" id="filter_iname" placeholder="Enter your nickname" onblur="myFunction()"-->
<!--                                         type="text">-->
<!--                <label id="lblnickname" style="color: blueviolet;margin-top: 10px"></label>-->
<!--            </div>-->
<!---->
<!--            <div class="col-sm-1"><label>Room</label></div>-->
<!--            <div class="col-sm-2">-->
<!--                <select id="roomvin">-->
...
<!--            $("#errorname").html("System interruption");-->
<!--            return false;-->
<!--        }-->
