...
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td><label style="margin-left: 90px;margin-bottom:-2px;width: 60px">Money:</label></td>-->
<!--                            <td class="">-->
...
<!---->
<!---->
<!--                            <td><label  id = "labelvin" style="margin-left: 60px;margin-bottom:-2px;width: 70px;">Status</label></td>-->
...
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td><label  id = "labelvin" style="margin-left: 50px;margin-bottom:-2px;width: 100px;">Denominations vin</label></td>-->
...
<!--                                </select></td>-->
<!--                            <td><label  id = "labelvin" style="margin-left: 45px;margin-bottom:-2px;width: 100px;">Denominations xu</label></td>-->
...
<!--                            <td>-->
<!--                                <input style="margin-left: 20px;height:25px;width: 145px" id="nickname" name="nickname"></td>-->
<!--                            <td>-->
<!--                                <label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Giftcode:</label></td>-->
<!--                            <td>-->
<!--                                <input style="height:25px;width: 145px;margin-left:20px;"  id="giftcode" name="giftcode"></td>-->
<!--                        </tr>-->
<!--                    </table>-->
<!--                </div>-->
<!--                <div class="formRow">-->
...
<!---->
<!--                            <td>-->
<!--                                <label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Type giftcode:</label></td>-->
<!--                            <td class="item">-->
