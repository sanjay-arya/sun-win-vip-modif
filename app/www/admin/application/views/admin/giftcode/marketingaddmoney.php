    ...
    <!--<!--                                <option value="3000000">3,000,000 Coin</option>-->-->
    <!--<!--                                <option value="5000000">5,000,000 Coin</option>-->-->
    <!--<!--                                <option value="9000000">9,000,000 Coin</option>-->-->
    <!--<!--                                <option value="10000000">10,000,000 Coin</option>-->-->
    <!--<!--                            </select></td>-->-->
    <!--<!--                        <td>-->-->
    <!--<!--                            <label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Money:</label></td>-->-->
    <!--<!--                        <td class="item">-->-->
    ...
    <!--<!--                        </td>-->-->
    <!--<!--                        <td style="">-->-->
    <!--<!--                            <input type="button" id="search_tran" value="Add money marketing" class="button blueB"-->-->
    ...
    <!--//-->
    <!--//                    if (value.dup == 1) {-->
    <!--//                        $("#errogift").html("Account:   " + value.nickname + "  trùng vui lòng upload lại file");-->
    <!--//                        return false;-->
    <!--//                    } else if (value.dup == 0) {-->
    <!--//                        if ($("#money").val() == 1) {-->
    <!--//                            $.ajax({-->
    ...
    <!--//                                        $("#errogift").html("Account  " + result.message + "   không tồn tại vui lòng upload lại file");-->
    <!--//                                    } else if (result.errorCode == 0) {-->
    <!--//                                        $("#errogift").html("Add money thành công");-->
    <!--//                                    }-->
    <!--//-->
    <!--//                                }-->
    <!--//                            });-->
