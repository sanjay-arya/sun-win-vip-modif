...
<div class="wrapper">
    <div class="widget">
        <div class="title">
            <h6>Statistics on admin giftcodes used </h6>

        </div>
        <div class="formRow">
            <form class="list_filter form" action="<?php echo admin_url('giftcode/giftcodeuseadmin') ?>"  method="get">
                <table>
                    <tr>
                        <td><label  id = "labelvin" style="margin-left: 30px;margin-bottom:-2px;width: 60px;">Denominations</label></td>
                        ...
                        <td><label  id = "labelxu" style="margin-left: 30px;margin-bottom:-2px;width: 60px;display: none">Denominations</label></td>
