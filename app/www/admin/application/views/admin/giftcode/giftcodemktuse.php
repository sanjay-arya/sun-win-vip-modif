        ...
        <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td>
                            <label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Output source:</label></td>
                        <td class="item">
                            <select id="nguonxuat" name="nguonxuat"
                                    style="margin-left: 13px;margin-bottom:-2px;width: 150px">
                                <option value="" <?php if($this->input->post("nguonxuat")== ""){echo "selected";}  ?>>Select</option>
            ...
            <div class="formRow">
                <table>
                    <tr>
                        <td hidden><label style="margin-left: 84px;margin-bottom:-2px;width: 64px">Money:</label></td>
                        <td hidden>
...
function giftcodexu(){
    ...
    $.ajax({
        ...
        success: function (result1) {
            ...
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Denominations" + "</td>";
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Quantity" + "</td>";
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Used" + "</td>";
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Total amount spent" + "</td>";
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Locked" + "</td>";
            result += "<td style='color: #000000;font-size: 20px;text-align: right;font-weight: 600'>" + "Remaining" + "</td>";
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='"+ii+"' style='vertical-align: middle;color:#0000ff;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Agency" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='"+kk+"' style='vertical-align: middle;color:#0000ff;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Operate" + "</td>";
            result += "</tr>";
            ...
            $("#spinner").hide();
            $("#resultsearch").html("System overload. Please try again");
            $('#reportvt').html("");
        }, timeout: 40000
    });
}
...
function sumresult(quantity,use,lock,money){
    ...
    rs += "<td style='color: #0000ff;font-size: 20px;font-weight:700;text-align: right'>" + "Total" + "</td>";
...
function sumresulttong(quantity,use,lock,money){
    ...
    rs += "<td colspan='2' style='color: #0000ff;font-size: 20px;font-weight:700;text-align: right'>" + "Total" + "</td>";
    rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right;'>" + commaSeparateNumber(quantity) + "</td>";
    rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(use) + "</td>";
    rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(money) + "</td>";
    rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(lock) + "</td>";
