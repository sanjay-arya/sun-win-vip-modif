...
<div class="wrapper">
    <div class="widget">
        ...
        <?php if ($admin_info->Status == "A"): ?>
            <div class="title">
                <h4>Edit config <span style="color: #0000FF"></span></h4>
            </div>
            <div class="formRow">
                <div class="row">
                    <div class="col-sm-1">
                        <input type="button" id="search_tran" value="Save configuration" class="button blueB">
                    </div>
                </div>
            </div>
...
<script>    $("#search_tran").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo admin_url('confignew/successeditslothandleajax')?>",
                data: {
                    t: c,
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('confignew/editslothandleajax')?>",
            data: {
                t: c
            },
            dataType: 'json',
