...
<div class="wrapper">
    <div class="widget">
        ...
        <?php if ($admin_info->Status == "A"): ?>
            <div class="title">
                <h4>Edit disk shock config<span style="color: #0000FF"></span></h4>
            </div>
            <div class="formRow">
                <div class="row">
                    <div class="col-sm-1">
...
<script>
    $("#search_tran").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('confignew/successeditxdajax')?>",
            data: {
                t: c,
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('confignew/editxdajax')?>",
            data: {
                t: c
            },
            dataType: 'json',
