...
<!--        <div class="formRow">-->
<!--            <h4>Đối soát nạp vin từ VTC</h4>-->
<!--        </div>-->
<!--        <form class="list_filter form" action="--><?php //echo admin_url('report/doisoatfromvtc') ?><!--" method="post">-->
<!---->
<!--            <div class="formRow">-->
<!--                <table>-->
<!--                    <tr>-->
...
<!--        $.ajax({-->
<!--            type: "POST",-->
<!--            url: "--><?php //echo admin_url('report/doisoatfromvtcajax')?>//",
//            data: {
...
//                console.log(result1.trans);
//                $("#spinner").hide();
//                var i = 2;
//                $.each(result1.trans, function (index, value) {
//                    i++;
//                });
//                result += "<tr>";
...
//                result += "</tr>";
//                result += "<tr>";
//                result += "<td rowspan='" + i + "' style='vertical-align: middle;color:#0000ff;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "VTC" + "</td>";
//                result += "</tr>";
//
//                for (var j = result1.trans.length - 1; j >= 0; j--) {
//                    if (result1.trans[j].quantity > 0) {
//                        result += resultvincard(result1.trans[j].faceValue, result1.trans[j].quantity, result1.trans[j].moneyTotal);
//                        total1 += result1.trans[j].quantity;
//                        total2 += result1.trans[j].moneyTotal;
//                        total3 += result1.trans[j].moneyTotal;
//                    }
//                }
...
//        rs += "<td style='color: #ba9406;font-size: 20px;font-weight:700;text-align: right'>" + "Total" + "</td>";
