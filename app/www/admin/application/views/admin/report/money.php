...
<?php else: ?>
    ...
    <tr class="moneysystem">
        <td>Recharge from VTC</td>
        <td class="tdmoney" id="money77"></td>
        <td class="tdmoney" id="money88"></td>
    </tr>
    <tr class="moneysystem">
        <td style="color: #ba9406;font-size: 20px;font-weight:700">Total user nạp</td>
    ...
    <tr>
        <td style="color: #ba9406;font-size: 20px;font-weight:700">Total sự kiện quà tặng</td>
    ...
    <tr>
        <td style="color:  #0000ff;font-size: 20px;font-weight:700">Total money vào</td>
    ...
    <tr>
        ...
        <td colspan="3" style="color: #000000;font-size: 18px;font-weight: 600">Money đổi thưởng</td>
    </tr>
    <tr class="moneysystem">
        <td>Đổi thẻ</td>
    ...
    <tr>
        <td style="color: #ba9406;font-size: 20px;font-weight:700">Total money ra</td>
    ...
    <tr>
        <td colspan="3" style="color: #000000;font-size: 18px;font-weight: 600">Agency</td>

    </tr>
    <tr class="moneysystem">
        <td>Total money đại lý đầu Month</td>
        <td class="tdmoney" ></td>
        <td class="tdmoney" id="money36">0</td>
    </tr>
    <tr class="moneysystem">
        <td>Total money đại lý cuối Month</td>
        <td class="tdmoney" ></td>
        <td class="tdmoney" id="money37">0</td>
    </tr>
    <tr>
        <td style="color: #ba9406;font-size: 20px;font-weight:700">Money lệch đại lý</td>
    ...
    <tr>
        <td style="color: #0000ff;font-size: 20px;font-weight:700">Total money đổi thưởng</td>
    ...
    <tr>
        <td rowspan="9"
            style="vertical-align: middle;color:#0000ff;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px">
            Money hệ thống thu được
        </td>
        <td colspan="3" style="color:#000000;font-size: 18px;font-weight: 600">Money hệ thống thu</td>
    </tr>
    <tr class="moneysystem">
        <td>Minigame</td>
        <td class="tdmoney"></td>
    ...
    <tr>
        <td style="color: blue;font-size: 20px;font-weight:700">Total</td>
    ...
    <tr>
        <td rowspan="4"
            style="vertical-align: middle;color:#0000ff;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px">
            Money tồn trong user
        </td>
        <td colspan="3" style="color: #000000;font-size: 18px;font-weight: 600">Money trong user</td>
    </tr>
    <tr class="moneysystem">
        <td>Total money trong user đầu Month</td>
        <td class="tdmoney" ></td>
        <td class="tdmoney" id="money50"></td>
    </tr>
    <tr class="moneysystem">
        <td>Total money trong user cuối Month</td>
        <td class="tdmoney" ></td>
        <td class="tdmoney" id="money51"></td>
    </tr>

    <tr>
        <td style="color: #0000ff;font-size: 20px;font-weight:700">Money lệch user</td>
