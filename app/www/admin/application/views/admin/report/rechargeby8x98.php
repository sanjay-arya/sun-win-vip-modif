...
<!--            <div class="title">-->
<!--                <h6>Lịch sử nạp Win 8x98</h6>-->
<!--            </div>-->
<!--            <form class="list_filter form" action="--><?php //echo admin_url('report/rechargeby8x98') ?><!--" method="post">-->
<!--                <div class="formRow">-->
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td>-->
...
<!--                            <td><label style="margin-left: 70px;margin-bottom:-2px;width: 100px">Denominations:</label></td>-->
<!--                            <td class="">-->
...
<!--                            <td><label style="margin-left: 70px;margin-bottom:-2px;width: 100px">Status:</label></td>-->
<!--                            <td class="">-->
<!--                                <select id="select_status" name="select_status"-->
<!--                                        style="margin-left: 0px;margin-bottom:-2px;width: 143px">-->
<!--                                    <option value="">Select</option>-->
<!--                                    <option value="0" --><?php //if($this->input->post('select_status') == "0" ){echo "selected";} ?><!-->Success</option>-->
<!--                                </select>-->
<!--                            </td>-->
<!---->
<!---->
...
<!---->
<!--                            <td><label style="margin-left: 70px;margin-bottom:-2px;width: 100px">Đầu số:</label></td>-->
<!--                            <td class="">-->
<!--                                <select id="select_dauso" name="select_dauso"-->
<!--                                        style="margin-left: 0px;margin-bottom:-2px;width: 143px">-->
<!--                                    <option value="">Select</option>-->
...
<!--                            <td>-->
<!--                                <input type="reset"-->
<!--                                       onclick="window.location.href = '--><?php //echo admin_url('report/rechargeby8x98') ?>//'; "
