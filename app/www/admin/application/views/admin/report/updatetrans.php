<div class="titleArea">
	<div class="wrapper">
		<div class="pageTitle">
			<h5>Update giao dịch rút tiền</h5>
...
<div class="line"></div>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            <div class="title">
                <h6>Update giao dịch #<?php echo( $dataTrans['data']['Id']) ?></h6>
            </div>
            <form class="list_filter form" action="" method="post">
                ...
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-sm-2"><label><?php echo $dataTrans['data']['Username'] ?></label></div>
                ...
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-sm-2"><label>Amount of money </label></div>
                ...
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-sm-2"><label><?php echo $dataTrans['data']['BankName'] ?></label></div>
                ...
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <input type="button" id="congxu" value="Update" class="button blueB">
                        </div>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p style="color: #7a6fbe">Update trạng thái thành công</p>
                        </div>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result != ""){
                        ...
                        $("#errorname").html("Update thất bại!");
                    }
                }, error: function () {
                    $("#spinner").hide();
