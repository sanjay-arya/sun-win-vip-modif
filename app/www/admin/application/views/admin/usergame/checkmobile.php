  ...
  <!--<!--                        <label class="col-sm-1 control-label" for="exampleInputEmail1">Phone number:</label>-->-->
  <!--<!---->-->
  <!--<!--                        <div class="col-sm-2">-->-->
  ...
  <!--<!--                        </div>-->-->
  <!--<!--                </form>-->-->
  <!--<!--                <div class="col-sm-1"><input type="button" id="openuser" value="Search" class="button blueB">-->-->
  <!--<!--                </div>-->-->
  <!--<!--                <td style="">-->-->
  ...
  <!--//                            $("#errocode").html("Phone number không tồn tại:" + (res.lstPhone));-->
  <!--//-->
  <!--//                            stt1 = 1;-->
