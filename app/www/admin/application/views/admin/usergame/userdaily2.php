...
<!--            <div class="title">-->
<!--                <h6>List tài khoản đại lý cấp 2</h6>-->
<!--                <h6 style="float: right">Total số tài khoản:<span style="color:#0000ff" id="numuser"></span></h6>-->
<!--            </div>-->
<!--            <form class="list_filter form" action="--><?php //echo admin_url('usergame/userdaily2') ?><!--" method="post">-->
<!--                <div class="formRow">-->
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td>-->
...
<!--                                                         style="margin-left: 5px;margin-bottom:-2px;width: 150px">-->
<!--                                        <option value="2" --><?php //if($this->input->post('typetaikhoan') == "2" ){echo "selected";} ?><!-->Agency cấp 2</option>-->
<!--                                    </select>-->
<!--                                </td>-->
<!--                            --><?php //endif ;?>
<!--                            <td>-->
...
<!--                            <td>-->
<!--                                <input type="reset"-->
<!--                                       onclick="window.location.href = '--><?php //echo admin_url('usergame/userdaily2') ?>//'; "
