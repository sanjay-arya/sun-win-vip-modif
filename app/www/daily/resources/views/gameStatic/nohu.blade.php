                                                    ...
                                                    <div class="card-body table-responsive p-0">
                                                        <table class="table table-hover text-nowrap">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>{{__('base.time')}}</th>
                                                                <th>{{__('base.slot_bitcoin')}}</th>
                                                                <th>{{__('base.slot_monkey_king')}}</th>
                                                                <th>{{__('base.slot_angry_birds')}}</th>
                                                                <th>{{__('base.slot_fortune')}}</th>
                                                                <th>{{__('base.slot_sport')}}</th>
                                                                <th>{{__('base.slot_astrology')}}</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$item['bitcoint']}}</td>
                                                                <td>{{$item['taydu']}}</td>
                                                                <td>{{$item['angrybird']}}</td>
                                                                <td>{{$item['thantai']}}</td>
                                                                <td>{{$item['thethao']}}</td>
                                                                <td>{{$item['chiemtinh']}}</td>
                                                            </tr>
