...
public class AgentUtils {
	private static final Logger logger = Logger.getLogger("Agent utils");
	...
	public static BaseResponse<Object> searchChilds(int id, String keyword, int level, int pageIndex, int limit) {
		...
		try {
			...
			logger.error("[GET CHILDS OF AGENT] Exception: " + e.getMessage());
			return res;
		}
	}
	
	public static BaseResponse<Object> searchChilds4AdminAgent(int id, String keyword, int level, int pageIndex, int limit) {
		BaseResponse<Object> res = new BaseResponse<Object>();
		res.setData(null);
		res.setTotalRecords(0);
		res.setErrorCode("1001");
		...
		res.setSuccess(false);
		try {
			Map<String, Object> map = agentDao.searchChilds4AdminAgent(id, keyword, level , pageIndex, limit);
			res.setTotalRecords(Integer.parseInt(map.get("total").toString()));
			res.setData(map.get("agents"));
			res.setMessage("success");
			res.setErrorCode("0");
	...
	public static BaseResponse<Object> searchChilds4BO(int id, String keyword, int level, int pageIndex, int limit) {
		BaseResponse<Object> res = new BaseResponse<Object>();
		res.setData(null);
		res.setTotalRecords(0);
		res.setErrorCode("1001");
		...
		res.setSuccess(false);
		try {
			Map<String, Object> map = agentDao.searchChilds4BO(id, keyword, level , pageIndex, limit);
			res.setTotalRecords(Integer.parseInt(map.get("total").toString()));
			res.setData(map.get("agents"));
			res.setMessage("success");
			res.setErrorCode("0");
	...
	public static BaseResponse<Object> searchParents(int id, String keyword, int level, int pageIndex, int limit) {
		BaseResponse<Object> res = new BaseResponse<Object>();
		res.setData(null);
		res.setTotalRecords(0);
		res.setErrorCode("1001");
		...
		res.setSuccess(false);
		try {
			Map<String, Object> map = agentDao.searchParents(id, keyword, level , pageIndex, limit);
			res.setTotalRecords(Integer.parseInt(map.get("total").toString()));
			res.setData(map.get("agents"));
			res.setMessage("success");
			res.setErrorCode("0");
			...
			logger.error("[GET PARENTS OF AGENT] Exception: " + e.getMessage());
			return res;
		}
	}
	
	public static BaseResponse<Object> searchAgentMix(int id, String keyword, int level, int pageIndex, int limit) {
		BaseResponse<Object> res = new BaseResponse<Object>();
		res.setData(null);
		res.setTotalRecords(0);
		res.setErrorCode("1001");
		...
		res.setSuccess(false);
		try {
			Map<String, Object> map = agentDao.searchAgentMix(id, keyword, level , pageIndex, limit);
			res.setTotalRecords(Integer.parseInt(map.get("total").toString()));
			res.setData(map.get("agents"));
			res.setMessage("success");
			res.setErrorCode("0");
