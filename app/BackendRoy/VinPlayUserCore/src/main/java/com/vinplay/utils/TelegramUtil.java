...
public class TelegramUtil {
    ...
    public static boolean warningCheat(String message){
    	String chatId ="@qweqwe12df"; 
    	String bootToken ="5215704706:AAGF1nDu1ZaGKOPqLYsn6dpLvuQbaKw_HLA";
	...
	public String pushMessageTelegram(String msg) {
		...
		if (msg == null || "".equals(msg))
			return "";
		//, 
		urlString = String.format(urlString, "5215704706:AAGF1nDu1ZaGKOPqLYsn6dpLvuQbaKw_HLA", "@qweqwe12df",
				msg);
