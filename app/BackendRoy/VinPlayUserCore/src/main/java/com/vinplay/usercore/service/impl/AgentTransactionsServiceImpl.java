...
public class AgentTransactionsServiceImpl implements AgentTransactionsService {
	...
	@Override
	public Map<String, Object> search(String keyword, int status, String timeStart, String timeEnd, int page, int maxItem) {
		try {
			return dao.search(keyword, status, timeStart, timeEnd, page, maxItem);
		} catch (Exception e) {
			logger.error("Error delete bank of agent: " + e.getMessage());
			return new HashMap<>();
		}
	...
	@Override
	public Map<String, Object> searchWithAgentCode(String agentCode, int status, String timeStart, String timeEnd, int page, int maxItem) {
		try {
			return dao.searchWithAgentCode(agentCode, status, timeStart, timeEnd, page, maxItem);
		} catch (Exception e) {
			logger.error("Error delete bank of agent: " + e.getMessage());
			return new HashMap<>();
		}
