...
public class WithDrawPaygateDaoImpl implements WithDrawPaygateDao {
	...
	public long Add(WithDrawPaygateModel withDrawPaygateModel) {
		try {
			...
			doc.append("CartId", withDrawPaygateModel.CartId);
			doc.append("ReferenceId", withDrawPaygateModel.ReferenceId);
			...
			doc.append("AgentBankAccountName", withDrawPaygateModel.AgentBankAccountName);
			doc.append("AgentBankAccountNumber", withDrawPaygateModel.AgentBankAccountNumber);
			doc.append("AgentBankCode", withDrawPaygateModel.AgentBankCode);
			doc.append("Content", withDrawPaygateModel.Content);
	...
	public Boolean UpdateInfo(WithDrawPaygateModel withDrawPaygateModel) {
		try {
			MongoDatabase db = MongoDBConnectionFactory.getDB();
			BasicDBObject updateFields = new BasicDBObject();
			updateFields.append("CreatedAt", withDrawPaygateModel.CreatedAt);
			...
			updateFields.append("CartId", withDrawPaygateModel.ReferenceId);
			updateFields.append("ReferenceId", "");
			updateFields.append("UserId", withDrawPaygateModel.UserId);
			updateFields.append("Username", withDrawPaygateModel.Username);
			updateFields.append("Nickname", withDrawPaygateModel.Nickname);
			updateFields.append("RequestTime", withDrawPaygateModel.RequestTime);
	...
	public WithDrawPaygateModel GetById(String Id) {
		try {
			...
			WithDrawPaygateModel model = new WithDrawPaygateModel(document.getString("Id"),
					...
					document.getString("BankBranch"), document.getString("UserApprove"), document.getString("Description"),
			...
			iterable.forEach((Block) new Block<Document>() {
				public void apply(Document document) {
					WithDrawPaygateModel model = new WithDrawPaygateModel(
						...
						document.getString("AgentBankCode"),
						document.getString("AgentBankAccountName"),
						document.getString("AgentBankAccountNumber"),
