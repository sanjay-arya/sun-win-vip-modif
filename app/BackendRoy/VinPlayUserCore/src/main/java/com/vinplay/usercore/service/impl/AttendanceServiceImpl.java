...
public class AttendanceServiceImpl implements AttendanceService {
	...
	public String createConfig(AttendanceConfig attendanceConfig) {
		try {
			String result = "";
			AttendanceConfigDao dao = new AttendanceConfigDaoImpl();
...
//			}
			...
			String rs = dao.insert(attendanceConfig);
			//TODO: Set cached
			setAttendanceConfigToCached();
			return rs;
		} catch (Exception e) {
	...
	public Map<String, Object> Attendance(String nickname) {
		...
		try {
			...
			if (userAttendanceLastest == null) {
				...
				short[] diceResult = getDice(nickname);
			...
			UserAttendanceDao dao = new UserAttendanceDaoImpl();
	...
	private static final short[] BIG_VALUE = { 4, 5, 7, 8, 10, 13, 14, 16, 17, 11, 3, 6, 9, 12, 15, 18, 5, 7, 8, 10, 13 };
	private static final short[] MIN_VALUE = { 4, 5, 7, 8, 10, 4, 5, 7 ,8};
	private static final short[] MEDIUM_VALUE = { 4, 5, 7, 8, 10, 13, 14, 16, 17, 11, 3, 8, 10, 13 };// 11

	private short[] getDice(String nickName) {
		UserService userService = new UserServiceImpl();
	...
	private long[] CalculatorMoney(short[] diceResult, AttendanceConfig attendanceConfig, int consecutive) {
		...
		switch (index) {
		case 1:
			return new long[] { 200, 0, 0 };
		case 2:
			return new long[] { 350, 0, 0 };
		case 3:
			return new long[] { 500, 0, 0 };
		case 4:
			return new long[] { 650, 0, 0 };
		case 5:
			return new long[] { 800, 0, 0 };
		case 6:
			return new long[] { 1000, 0, 0 };
		default:
