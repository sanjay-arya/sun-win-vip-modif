...
public class UpdatePhoneNumberProcessor implements BaseProcessor<HttpServletRequest, String> {
	...
	public String execute(Param<HttpServletRequest> param) {
		...
		if (!isToken) {
			return BaseResponse.error(Constant.ERROR_SESSION, "Your trading session is expired, please reload page and login again.");
		}
		try {
		...
		try {
			if (userService.isPhoneUsed(phone, nickName)) {
				...
				return BaseResponse.error(Constant.ERROR_PARAM, "This telephone number is used");
			}
