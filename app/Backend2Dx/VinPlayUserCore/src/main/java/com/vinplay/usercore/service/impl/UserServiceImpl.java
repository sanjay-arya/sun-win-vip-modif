...
public class UserServiceImpl
    ...
    public long getMoneyCashout(String nickname) throws ParseException {
        ...
        IMap<String, UserModel> userMap = client.getMap("users");
        if (userMap.containsKey((Object) nickname)
                && (user = (UserCacheModel) userMap.get((Object) nickname)).getCashoutTime() != null
        ...
        block19: {
            ...
            try {
                ...
                if (statusGame == StatusGames.SANDBOX.getId()
                        && !((UserCacheModel) userMap.get((Object) nickname)).isCanLoginSandbox()) {
                    logger.debug((Object) ("Response checkSessionKey: server maintain" + res.toJson()));
                    res.setErrorCode("1114");
                    return res;
                }
    ...
    public MoneyResponse updateMoney(String nickname, long money, String moneyType, String gameName, String serviceName,
        ...
        logger.debug((Object) ("Request updateMoney:  nickname: " + nickname + ", money: " + money + ", moneyType: "
                        ...
                        try {
                            ...
                            if (moneyVP > 0L) {
                                ...
                                if (vpAddEvent > 0) {
                                    ...
                                    RMQApi.publishMessage((String) "queue_vippoint_event", (BaseMessage) vpEventMessage,
                                            (int) 801);
                                }
                            }
                            ...
                            MoneyMessageInMinigame message = new MoneyMessageInMinigame(VinPlayUtils.genMessageId(),
                                    user.getId(), nickname, gameName, moneyUser, currentMoney, money, moneyType, fee,
                                    moneyVPs, vp);
    ...
    public BaseResponseModel updateMoneyFromAdmin(String nickname, long money, String moneyType, String actionName,
        ...
        block11: {
            logger.debug((Object) ("Request updateMoneyFromAdmin:  nickname: " + nickname + ", money: " + money
                ...
                try {
                    ...
                    if (model != null) {
                        ...
                        if (userMap.containsKey((Object) nickname)) {
                            ...
                            logger.debug((Object) ("catch user in hazel"));
                            logger.debug((Object) moneyRes);
                            break block11;
                        }
                        try {
    ...
    public NapXuResponse napXu(String nickname, long moneyVinToXu, boolean check) {
        ...
        block20: {
            ...
            try {
                ...
                if (!(userMap = client.getMap("users")).containsKey((Object) nickname))
                    break block20;
                try {
                    userMap.lock(nickname);
                    UserCacheModel user = (UserCacheModel) userMap.get((Object) nickname);
                                ...
                                if (check && user.getMobile() != null && user.isHasMobileSecurity()) {
                                    ...
                                    try {
                                        ...
                                        LogMoneyUserMessage messageLogVin = new LogMoneyUserMessage(user.getId(),
                                                nickname, "NapXu", "N\u1ea1p Coin", currentMoneyVin, -moneyVinToXu, "vin",
                                                "Chuy\u1ec3n Vin sang Coin", 0L, false, user.isBot());
                                        RMQApi.publishMessagePayment((BaseMessage) message, (int) 16);
                                        ...
                                        LogMoneyUserMessage messageLogXu = new LogMoneyUserMessage(user.getId(),
                                                nickname, "NapXu", "N\u1ea1p Coin", currentMoneyXu, moneyXuAdded, "xu",
                                                "Chuy\u1ec3n Vin sang Coin", 0L, false, user.isBot());
                                        RMQApi.publishMessagePayment((BaseMessage) message, (int) 16);
    ...
    public TransferMoneyResponse transferMoney(String nicknameSend, String nicknameReceive, long vin,
        ...
        int status;
        block71: {
            logger.debug((Object) ("Request transferMoney: nicknameSend: " + nicknameSend + ", nicknameReceive: "
            ...
            try {
                ...
                if (userReceive != null) {
                    ...
                    if (userMap.containsKey((Object) nicknameReceive)) {
                        userCacheReceive = (UserCacheModel) userMap.get((Object) nicknameReceive);
                    }
                    if (userSend == null || userCacheReceive == null)
                        return res;
                    /*
                     * if (userSend.getDaily() == 0 && userCacheReceive.getDaily() == 0) {
                     * res.setCode((byte) 11);
                     * return res;
                     * }
                     */
                                                ...
                                                if (moneyUser >= vin) {
                                                    ...
                                                    if (userMap.containsKey((Object) nicknameReceive)) {
                                                        try {
                                                            ...
                                                            RMQApi.publishMessagePayment((BaseMessage) messageSend,
                                                                    (int) 16);
                                                            RMQApi.publishMessageLogMoney(
                                                                    (LogMoneyUserMessage) messageLogSend);
                                                            RMQApi.publishMessagePayment((BaseMessage) messageReceive,
                                                                    (int) 16);
                                                            RMQApi.publishMessageLogMoney(
                                                                    (LogMoneyUserMessage) messageLogReceive);
                                                            if (status != 0) {
                                                                LogChuyenTienDaiLyMessage messageDaily = new LogChuyenTienDaiLyMessage(
                                                                        ...
                                                                        1, this.getAgentLevel1(nicknameSend,
                                                                                nicknameReceive),
                                                                        "");
                                                                RMQApi.publishMessage(
                                                                        (String) "queue_log_chuyen_tien_dai_ly",
                                                                        (BaseMessage) messageDaily, (int) 602);
                                                            }
                                                            if (sendSMS) {
                                                                if (feeSMS > 0) {
                                                                    userCacheReceive
                                                                    ...
                                                                    RMQApi.publishMessagePayment(
                                                                            (BaseMessage) messageReceiveSMSFee,
                                                                            (int) 16);
                                                                    RMQApi.publishMessageLogMoney(
                                                                            (LogMoneyUserMessage) messageLogReceiveSMSFee);
                                                                }
                                                    ...
                                                    try {
                                                        ...
                                                        RMQApi.publishMessagePayment((BaseMessage) messageSend2,
                                                                (int) 16);
                                                        RMQApi.publishMessageLogMoney(
                                                                (LogMoneyUserMessage) messageLogSend2);
                                                        userMap.put(nicknameSend, userSend);
                                                        ;
                                                        context.commitTransaction();
                                                        res.setCode((byte) 0);
                                                        ...
                                                        if (status != 0) {
                                                            ...
                                                            RMQApi.publishMessage(
                                                                    (String) "queue_log_chuyen_tien_dai_ly",
                                                                    (BaseMessage) messageDaily2, (int) 602);
                                                        }
                                                        if (sendSMS) {
                                            ...
                                            if (moneyUser2 >= vin) {
                                                ...
                                                if (userMap.containsKey((Object) nicknameReceive)) {
                                                    try {
                                                        ...
                                                        RMQApi.publishMessagePayment((BaseMessage) messageSend3,
                                                                (int) 16);
                                                        RMQApi.publishMessageLogMoney(
                                                                (LogMoneyUserMessage) messageLogSend3);
                                                        RMQApi.publishMessagePayment((BaseMessage) messageReceive2,
                                                                (int) 16);
                                                        RMQApi.publishMessageLogMoney(
                                                                (LogMoneyUserMessage) messageLogReceive3);
                                                        if (status != 0) {
                                                            ...
                                                            RMQApi.publishMessage(
                                                                    (String) "queue_log_chuyen_tien_dai_ly",
                                                                    (BaseMessage) messageDaily3, (int) 602);
                                                        }
                                                        if (sendSMS) {
                                                            if (feeSMS > 0) {
                                                                userCacheReceive2
                                                                ...
                                                                RMQApi.publishMessageLogMoney(
                                                                        (LogMoneyUserMessage) messageLogReceiveSMSFee3);
                                                            }
                                                ...
                                                try {
                                                    ...
                                                    RMQApi.publishMessageLogMoney(
                                                            (LogMoneyUserMessage) messageLogSend4);
                                                    userMap.put(nicknameSend, userSend2);
                                                    context2.commitTransaction();
                                                    res.setCode((byte) 0);
                                                    res.setMoneyUse(moneyUser2);
                                                    ...
                                                    LogMoneyUserMessage messageLogReceive4 = new LogMoneyUserMessage(
                                                            ...
                                                            userReceive.isBot());
                                                    RMQApi.publishMessageLogMoney(
                                                            (LogMoneyUserMessage) messageLogReceive4);
                                                    if (status != 0) {
                                                        LogChuyenTienDaiLyMessage messageDaily4 = new LogChuyenTienDaiLyMessage(
                                                                ...
                                                                "");
                                                        RMQApi.publishMessage((String) "queue_log_chuyen_tien_dai_ly",
                                                                (BaseMessage) messageDaily4, (int) 602);
                                                    }
                                                    if (sendSMS) {
                                                        if (feeSMS > 0 && dao2.updateMoney(userReceive.getId(), -feeSMS,
                                                            ...
                                                            LogMoneyUserMessage messageLogReceiveSMSFee4 = new LogMoneyUserMessage(
                                                                    ...
                                                                    false, userReceive.isBot());
                                                            RMQApi.publishMessageLogMoney(
                                                                    (LogMoneyUserMessage) messageLogReceiveSMSFee4);
                                                        }
    ...
    public boolean checkAccesstoken(String nickname, String accessToken) {
        ...
        if (nickname != null && accessToken != null && !nickname.isEmpty() && !accessToken.isEmpty()) {
            try {
                ...
                IMap userMap = instance.getMap("users");
                if (userMap.containsKey((Object) nickname)
                        && (userCache = (UserCacheModel) userMap.get((Object) nickname)).getAccessToken()
                                .equals(accessToken)) {
                    res = true;
                }
            } catch (Exception e) {
