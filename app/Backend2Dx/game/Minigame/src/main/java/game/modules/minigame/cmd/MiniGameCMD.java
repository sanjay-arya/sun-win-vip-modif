...
public class MiniGameCMD {
    ...
    public static final short CHATMD5 = 23100;
    public static final short CHATMD5_SUBSCRIBE = 23101;
    public static final short CHATMD5_UNSUBSCRIBE = 23102;
    public static final short CHATMD5_LOG = 23103;

    public static final short CHATWORLD = 24100;
    public static final short CHATWORLD_SUBSCRIBE = 24101;
    public static final short CHATWORLD_UNSUBSCRIBE = 24102;
    public static final short CHATWORLD_LOG = 24103;
    ...
    //TXMINI
    public static final short TXMINI_VIN = 1;
    public static final short TXMINI_XU = 0;
    //
    public static final short SUBCRIBE_TXMINI_GAME = 2000;
    public static final short UNSUBCRIBE_TXMINI_GAME = 2001;
    public static final short CHANGE_ROOM = 2002;
    public static final short UPDATE_USER_INFO = 2003;
    public static final short BET_TAI_XIU = 21110;
    public static final short TAI_XIU_INFO = 21111;
    public static final short UPDATE_TAI_XIU_PER_SECOND = 21112;
    public static final short UPDATE_RESULT_DICES = 21113;
    public static final short UPDATE_PRIZE_TAI_XIU = 21114;
    public static final short START_NEW_GAME_TAI_XIU = 21115;
    public static final short LICH_SU_PHIEN_TX = 21116;
    public static final short LICH_SU_GIAO_DICH_TX = 21117;
    public static final short TAN_LOC = 21118;
    public static final short RUT_LOC = 21119;
    public static final short UPDATE_FUND_TAN_LOC = 21120;
    public static final short START_NEW_ROUND_RUT_LOC = 21121;
    public static final short UPDATE_SO_LUOT_RUT_LOC = 21122;
    public static final short ENABLE_RUT_LOC = 21123;
    public static final short BROADCAST_TX_TIME = 21124;
    //TXMINI_MD5
    public static final short SUBCRIBE_TXMINI_MD5_GAME = 22000;
    public static final short UNSUBCRIBE_TXMINI_MD5_GAME = 22001;
    public static final short UPDATE_TXMINI_MD5_USER_INFO = 22003;
    public static final short BET_TXMINI_MD5 = 22110;
    public static final short TXMINI_MD5_INFO = 22111;
    public static final short UPDATE_TXMINI_MD5_PER_SECOND = 22112;
    public static final short UPDATE_TXMINI_MD5_RESULT_DICES = 22113;
    public static final short UPDATE_TXMINI_MD5_PRIZE_TAI_XIU = 22114;
    public static final short START_NEW_GAME_TXMINI_MD5 = 22115;
    public static final short LICH_SU_PHIEN_TXMINI_MD5 = 22116;
    public static final short LICH_SU_GIAO_DICH_TXMINI_MD5 = 22117;
    public static final short BROADCAST_TXMINI_MD5_TIME = 22124;
    public static final short TXMINI_MD5_TAN_LOC = 22118;
    public static final short TXMINI_MD5_RUT_LOC = 22119;
    public static final short TXMINI_MD5_UPDATE_FUND_TAN_LOC = 22120;
    public static final short TXMINI_MD5_START_NEW_ROUND_RUT_LOC = 22121;
    public static final short TXMINI_MD5_UPDATE_SO_LUOT_RUT_LOC = 22122;
    public static final short TXMINI_MD5_ENABLE_RUT_LOC = 2123;
}
