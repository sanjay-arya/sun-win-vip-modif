...
public class SGGameRecordItem implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2375093885940619359L;
	private String id;
	...
	public String getRootpaytime() {
		return rootpaytime;
	}
	public void setRootpaytime(String rootpaytime) {
		this.rootpaytime = rootpaytime;
	}
