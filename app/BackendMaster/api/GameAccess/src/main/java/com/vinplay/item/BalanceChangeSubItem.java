...
public class BalanceChangeSubItem implements java.io.Serializable{
	private static final long serialVersionUID = 486971036412008498L;
	private String id;
	...
	public Double getCurentbetting() {
		return curentbetting;
	}
	public void setCurentbetting(Double curentbetting) {
		this.curentbetting = curentbetting;
	}
}
