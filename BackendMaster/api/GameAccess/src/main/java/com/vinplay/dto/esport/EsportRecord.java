...
public class EsportRecord implements Serializable {
	...
	private Boolean is_unsettled;// false,
	...
	public Boolean getIs_unsettled() {
		return is_unsettled;
	}

	public void setIs_unsettled(Boolean is_unsettled) {
	...
	public EsportRecord(String id, String bet_selection, Double odds, String currency, Double amount,
			...
			String result_status, Double earnings, Double handicap, Boolean is_combo, String member_code,
			Boolean is_unsettled, String ticket_type, Double malay_odds, Double euro_odds, Double member_odds,
	...
	public String toString() {
		return "EsportRecord [id=" + id + ", bet_selection=" + bet_selection + ", odds=" + odds + ", currency="
				+ currency + ", amount=" + amount + ", game_type_name=" + game_type_name + ", game_market_name="
				+ game_market_name + ", market_option=" + market_option + ", map_num=" + map_num + ", bet_type_name="
				+ bet_type_name + ", competition_name=" + competition_name + ", event_id=" + event_id + ", event_name="
				+ event_name + ", event_datetime=" + event_datetime + ", date_created=" + date_created
				+ ", settlement_datetime=" + settlement_datetime + ", modified_datetime=" + modified_datetime
				+ ", settlement_status=" + settlement_status + ", result=" + result + ", result_status=" + result_status
				+ ", earnings=" + earnings + ", handicap=" + handicap + ", is_combo=" + is_combo + ", member_code="
				+ member_code + ", is_unsettled=" + is_unsettled + ", ticket_type=" + ticket_type + ", malay_odds="
				+ malay_odds + ", euro_odds=" + euro_odds + ", member_odds=" + member_odds + ", member_odds_style="
				+ member_odds_style + ", game_type_id=" + game_type_id + ", request_source=" + request_source + "]";
	}
