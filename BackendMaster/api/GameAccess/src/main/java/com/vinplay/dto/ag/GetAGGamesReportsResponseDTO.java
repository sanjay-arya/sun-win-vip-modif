...
public class GetAGGamesReportsResponseDTO implements Serializable {
	...
	@XmlElement
	private List<AGGamesReportsDetailData> row;
	...
	public List<AGGamesReportsDetailData> getRow() {
		return row;
	}

	public void setRow(List<AGGamesReportsDetailData> row) {
		this.row = row;
	}
}
