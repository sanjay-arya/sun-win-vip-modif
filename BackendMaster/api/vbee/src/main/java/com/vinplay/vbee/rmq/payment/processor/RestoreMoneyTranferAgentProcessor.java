...
public class RestoreMoneyTranferAgentProcessor
implements BaseProcessor<byte[], Boolean> {
    ...
    public Boolean execute(Param<byte[]> param) {
        ...
        try {
            ...
            dao.updateTranferAgent(message.getTransactionNo(), 2, 1, message.getSessionId());
            dao.updateTranferAgentMySQL(message.getTransactionNo(), 2, 1, message.getSessionId());
            return true;
        }
        catch (Exception e2) {
