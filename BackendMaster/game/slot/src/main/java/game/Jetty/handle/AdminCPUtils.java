...
public class AdminCPUtils {
    ...
    public static BenleyRoom[] getListBenleyRoom() {
        BenleyRoom room10 = (BenleyRoom) BenleyModule.getInstance().rooms.get(BenleyModule.getInstance().gameName + "_vin_10");
        ...
        return new BenleyRoom[]{room10, room100, room1000};
    }
    ...
    public static ChiemTinhRoom[] getListChiemTinhRoom() {
        ChiemTinhRoom room10 = (ChiemTinhRoom) ChiemTinhModule.getInstance().rooms.get(ChiemTinhModule.getInstance().gameName + "_vin_10");
        ...
        return new ChiemTinhRoom[]{room10, room100, room1000};
    }
    ...
    public static AuditionRoom[] getListAuditionTamHungRoom() {
        AuditionRoom room10 = (AuditionRoom) AuditionModule.getInstance().rooms.get(AuditionModule.getInstance().gameName + "_vin_10");
        ...
        return new AuditionRoom[]{room10, room100, room1000};
    }
    ...
    public static TamHungRoom[] getListTamHungRoom() {
        TamHungRoom room10 = (TamHungRoom) TamHungModule.getInstance().rooms.get(TamHungModule.getInstance().gameName + "_vin_10");
        ...
        return new TamHungRoom[]{room10, room100, room1000};
    }
    ...
    public static SpartanRoom[] getListSpartanRoom() {
        SpartanRoom room10 = (SpartanRoom) SpartanModule.getInstance().rooms.get(SpartanModule.getInstance().gameName + "_vin_10");
        ...
        return new SpartanRoom[]{room10, room100, room1000};
    }
    ...
    public static MayBachRoom[] getListMayBachRoom() {
        MayBachRoom room10 = (MayBachRoom) MayBachModule.getInstance().rooms.get(MayBachModule.getInstance().gameName + "_vin_10");
        ...
        return new MayBachRoom[]{room10, room100, room1000};
    }
    ...
    public static RollRoyRoom[] getListRollRoyRoom() {
        RollRoyRoom room10 = (RollRoyRoom) RollRoyModule.getInstance().rooms.get(RollRoyModule.getInstance().gameName + "_vin_10");
        ...
        return new RollRoyRoom[]{room10, room100, room1000};
    }
    ...
    public static BikiniRoom[] getListBikiniRoom() {
        BikiniRoom room10 = (BikiniRoom) BikiniModule.getInstance().rooms.get(BikiniModule.getInstance().gameName + "_vin_10");
        ...
        return new BikiniRoom[]{room10, room100, room1000};
    }
