    ...
    public void run() {
       try {
          // Debug.trace("BotJackPotMinipokerTimer");
           ...
           int moneyToJackPot_10 = GameConfig.getInstance().slotRollRoyceBotConfig.randomJackPotPer5s(0);
           RollRoyRoom room10 = (RollRoyRoom)this.rollRoyModule.rooms.get(this.rollRoyModule.gameName + "_vin_10");
           room10.addMoneyToPot(moneyToJackPot_10);
           int moneyToJackPot_100 = GameConfig.getInstance().slotRollRoyceBotConfig.randomJackPotPer5s(1);
           ...
           int moneyToJackPot_1000 = GameConfig.getInstance().slotRollRoyceBotConfig.randomJackPotPer5s(2);
...
//
           ...
           if(currentTime > timeJackPot_10){
               ...
               room10.botEatJackpot(this.rollRoyModule.keyBotJackpotRRoyce +
