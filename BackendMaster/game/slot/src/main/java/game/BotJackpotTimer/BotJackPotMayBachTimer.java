...
public class BotJackPotMayBachTimer implements Runnable {
    ...
    public void run() {
       try {
           ...
           int moneyToJackPot_10 = GameConfig.getInstance().slotMayBachBotConfig.randomJackPotPer5s(0);
           MayBachRoom room10 = (MayBachRoom)this.mayBachModule.rooms.get(this.mayBachModule.gameName + "_vin_10");
           room10.addMoneyToPot(moneyToJackPot_10);
           int moneyToJackPot_100 = GameConfig.getInstance().slotMayBachBotConfig.randomJackPotPer5s(1);
           ...
           int moneyToJackPot_1000 = GameConfig.getInstance().slotMayBachBotConfig.randomJackPotPer5s(2);
...
//
           ...
           if(currentTime > timeJackPot_10){
               ...
               room10.botEatJackpot(this.mayBachModule.keyBotJackpotSlot9Icon +
