...
public class BotJackPotRangeRoverTimer implements Runnable {
    ...
    public BotJackPotRangeRoverTimer(long[] timeJackpot, RangeRoverModule rangeRoverModule){
        ...
        this.timeJackPot_1000 = timeJackpot[3];
    ...
    public void run() {
       try {
           ...
           int moneyToJackPot_10 = GameConfig.getInstance().slotRangeRoverBotConfig.randomJackPotPer5s(0);
           RangeRoverRoom room10 = (RangeRoverRoom)this.rangeRoverModule.rooms.get(this.rangeRoverModule.gameName + "_vin_10");
           room10.addMoneyToPot(moneyToJackPot_10);
           int moneyToJackPot_100 = GameConfig.getInstance().slotRangeRoverBotConfig.randomJackPotPer5s(1);
...
//           room5000.addMoneyToPot(moneyToJackPot_5000);
           int moneyToJackPot_1000 = GameConfig.getInstance().slotRangeRoverBotConfig.randomJackPotPer5s(3);
...
//
           ...
           if(currentTime > timeJackPot_10){
               ...
               room10.botEatJackpot(this.rangeRoverModule.keyBotJackpotSlot7IconWild +
...
//               room100.botEatJackpot(this.rangeRoverModule.keyBotJackpotSlot7IconWild +
//                       "_vin_5000",timeJackPot_100, this.bots.get(GameUtil.randomMax(this.bots.size())));
//           }
