...
public class BotJackPotSpartanTimer implements Runnable {
    ...
    public void run() {
       try {
           ...
           int moneyToJackPot_10 = GameConfig.getInstance().slotSpartanBotConfig.randomJackPotPer5s(0);
           SpartanRoom room10 = (SpartanRoom)this.spartanModule.rooms.get(this.spartanModule.gameName + "_vin_10");
           room10.addMoneyToPot(moneyToJackPot_10);
           int moneyToJackPot_100 = GameConfig.getInstance().slotSpartanBotConfig.randomJackPotPer5s(1);
...
//           room5000.addMoneyToPot(moneyToJackPot_5000);
           int moneyToJackPot_1000 = GameConfig.getInstance().slotSpartanBotConfig.randomJackPotPer5s(3);
...
//
           ...
           if(currentTime > timeJackPot_10){
               ...
               room10.botEatJackpot(this.spartanModule.keyBotJackpotSlot11IconWild +
