...
public class BotJackPotBentleyTimer implements Runnable {
    ...
    public void run() {
       try {
           ...
           BenleyRoom room100 = (BenleyRoom)this.bentleyModule.rooms.get(this.bentleyModule.gameName + "_vin_10");
           ...
           BenleyRoom room1000 = (BenleyRoom)this.bentleyModule.rooms.get(this.bentleyModule.gameName + "_vin_100");
           ...
           BenleyRoom room10000 = (BenleyRoom)this.bentleyModule.rooms.get(this.bentleyModule.gameName + "_vin_1000");
