...
public class RangeRoverRoom
    ...
    public RangeRoverRoom(RangeRoverModule module, byte id, String name, short moneyType, long pot, long fund, int betValue,
        ...
        this.gameID = Games.RANGE_ROVER.getId() + "";
        this.module = module;
...
//                        slot7IconWildTableInfo = new Slot7IconWildTableInfo(GiftType.JACKPOT,this.betValue, this.boxValues);
//                        slot7IconWildTableInfo.calculate(rowIndex);
