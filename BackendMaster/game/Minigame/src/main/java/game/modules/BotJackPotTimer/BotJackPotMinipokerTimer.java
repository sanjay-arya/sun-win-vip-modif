...
//           Debug.trace("BotJackPotMinipokerTimer");
           ...
           int moneyToJackPot_10 = GameConfig.getInstance().miniPokerBotConfig.randomJackPotPer5s(0);
           ...
           int moneyToJackPot_100 = GameConfig.getInstance().miniPokerBotConfig.randomJackPotPer5s(1);
           ...
           int moneyToJackPot_1000 = GameConfig.getInstance().miniPokerBotConfig.randomJackPotPer5s(2);
           ...
           if(currentTime > timeJackPot_10){
               ...
               room10.botEatJackpot(MiniPokerModule.keyBotJackpot + "_vin_10",timeJackPot_10,
