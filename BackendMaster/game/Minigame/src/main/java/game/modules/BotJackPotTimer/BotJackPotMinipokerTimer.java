...
//           Debug.trace("BotJackPotMinipokerTimer");
           ...
           if(currentTime > timeJackPot_100){
               ...
               room100.botEatJackpot(MiniPokerModule.keyBotJackpot + "_vin_10",timeJackPot_100,
           ...
           if(currentTime > timeJackPot_1000){
               ...
               room1000.botEatJackpot(MiniPokerModule.keyBotJackpot + "_vin_100",timeJackPot_1000,
                       this.bots.get(GameUtil.randomMax(this.bots.size())));
           }
           if(currentTime > timeJackPot_10000){
               ...
               room10000.botEatJackpot(MiniPokerModule.keyBotJackpot + "_vin_1000",timeJackPot_10000,
                       this.bots.get(GameUtil.randomMax(this.bots.size())));
           }
