<div class="modal fade bd-example-modal-lg" id="rejectModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content background-modal">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form-reject" action="">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <input type="text" hidden id="reject-modal" value="" name="id">
