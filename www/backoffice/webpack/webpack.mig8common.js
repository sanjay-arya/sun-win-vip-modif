    ...
    plugins: [
        new webpack.DefinePlugin({
            'process.env': {
                ...
                // for dev environment SERVER_API_URL: `"http${options.tls ? 's' : ''}://localhost:9090/"`
                // for staging environment SERVER_API_URL: `"http${options.tls ? 's' : ''}://stagtxcb.vnloto.com:9090/"`
                // for pro environment ...
                //SERVER_API_URL: options.env === 'development' ? `"http://localhost:9090/"` : `"http://localhost:9090/"` // local
                SERVER_API_URL: options.env === 'production' ? `"https://st.suvip.bet/"` : `"https://st.suvip.bet/"`
            }
        }),
