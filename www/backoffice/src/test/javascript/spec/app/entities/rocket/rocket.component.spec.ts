...
import { RocketComponent } from 'app/entities/rocket/rocket.component';
import { RocketService } from 'app/entities/rocket/rocket.service';
import { Rocket } from 'app/shared/model/rocket.model';

describe('Component Tests', () => {
  describe('Rocket Management Component', () => {
    let comp: RocketComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RocketComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rockets && comp.rockets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
