...
describe('Service Tests', () => {
  describe('Rocket Service', () => {
    ...
    let elemDefault: IRocket;
    let expectedResult: IRocket | IRocket[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RocketService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Rocket(0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Rocket', () => {
        ...
        service.create(new Rocket()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Rocket', () => {
        const returnedFromService = Object.assign({}, elemDefault);
