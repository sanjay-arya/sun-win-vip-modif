...
import { ReportGameComponent } from 'app/entities/report-game/report-game.component';
...
describe('Component Tests', () => {
  describe('ReportGame Management Component', () => {
    let comp: ReportGameComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReportGameComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reportGames && comp.reportGames[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
