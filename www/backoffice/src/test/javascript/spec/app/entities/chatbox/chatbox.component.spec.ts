  ...
  describe('Chatbox Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChatboxComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chatboxes && comp.chatboxes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
