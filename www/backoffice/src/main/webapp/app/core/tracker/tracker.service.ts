...
// import { PayloadObj } from './tracker.model';
...
export class TrackerService {
  ...
  connect(): void {
    ...
    this.stompClient.connect(headers, () => {
     ...
     // const payloadObj = new PayloadObj(1, 1, 1, 1, 1);
     // this.sendActivity();
  ...
  subscribe(): void {
    ...
    this.connectionSubscription = this.connectionSubject.subscribe(() => {
      if (this.stompClient) {
        this.stompSubscription = this.stompClient.subscribe('/topic/tx', (data: Stomp.Message) => {
