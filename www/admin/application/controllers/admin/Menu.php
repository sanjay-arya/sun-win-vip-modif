...
//select category
    ...
    function get_list_menu()
    {
        ...
        foreach ($categorys as $category) {
            ...
            $str .= " <td class=\"option\">";
            $str .= "           <a href=" . admin_url('menu/edit/' . $category->id) . " class=\"tipS \" original-title=\"Edit\">";
            $str .= "      <img src=" . public_url('admin') . "/images/icons/color/edit.png>";
            $str .= "       </a>";
            $str .= "     <a href=" . admin_url('menu/delete/' . $category->id) . " class=\"tipS verify_action\" original-title=\"Erase\">";
    ...
    function get_sub_list_menu($category_ids, $i = 0)
    {
        ...
        if ($sub_categorys) {
            ...
            foreach ($sub_categorys as $sub_category) {
                ...
                $str .= " <td class=\"option\">";
                $str .= "           <a href=" . admin_url('menu/edit/' . $sub_category->id) . " class=\"tipS \" original-title=\"Edit\">";
                $str .= "      <img src=" . public_url('admin') . "/images/icons/color/edit.png>";
                $str .= "       </a>";
                $str .= "     <a href=" . admin_url('menu/delete/' . $sub_category->id) . " class=\"tipS verify_action\" original-title=\"Erase\">";
                $str .= "     <img src=" . public_url('admin') . "/images/icons/color/delete.png>";
                $str .= "     </a>";
                $str .= " </td>";
                $str .= "</tr>";
