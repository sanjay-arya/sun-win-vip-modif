...
Class Marketing extends MY_Controller
{
    ...
    function addcampain(){
        ...
        //neu ma co du lieu post len thi kiem tra
        if ($this->input->post()) {
            $this->form_validation->set_rules('recampain', 'Name utm_campain request', 'required');
            $this->form_validation->set_rules('discampain', 'Name utm_campain Display', 'required');
            //nhập liệu chính xác
            if ($this->form_validation->run()) {
                //them vao csdl
    ...
    function addsource(){
        ...
        //neu ma co du lieu post len thi kiem tra
        if ($this->input->post()) {
            $this->form_validation->set_rules('resource', 'Name utm_source request', 'required');
            $this->form_validation->set_rules('dissource', 'Name utm_source Display', 'required');
            //nhập liệu chính xác
            if ($this->form_validation->run()) {
                //them vao csdl
    ...
    function addmedium(){
        ...
        //neu ma co du lieu post len thi kiem tra
        if ($this->input->post()) {
            $this->form_validation->set_rules('remedium', 'Name utm_medium request', 'required');
            $this->form_validation->set_rules('dismedium', 'Name utm_medium Display', 'required');
            //nhập liệu chính xác
            if ($this->form_validation->run()) {
                //them vao csdl
