...
<?php else: ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                <h6>Check Money transactions</h6>
            </div>
            <form class="list_filter form">
                ...
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-sm-1"><label>Enter tokens</label></div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="txttoken">
                        </div>
                        <div class="col-sm-1"><input type="button" id="search_tran" value="Update"
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: #0000ff">You have successfully updated your transaction </p>
                </div>
