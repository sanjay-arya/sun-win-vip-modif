...
<div class="wrapper">
    ...
    <div class="widget">
        ...
        <div class="title">
            <h6>Account history of selling vin to dealers</h6>
        </div>
        <form class="list_filter form" action="<?php echo admin_url('transaction/agentsale') ?>" method="post">
            <div class="formRow">
                <table>
                    <tr>
                        <td>
            ...
            <div class="formRow">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="reset"
                                   onclick="window.location.href = '<?php echo admin_url('transaction/agentsale') ?>'; "
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            ...
            <tr style="height: 20px;">
                ...
                <td>Accounts get</td>
                <td>Vin number sent</td>
                <td>Vin number received</td>
                <td>Transfer fees</td>
                <td>Status</td>
                <td>Time</td>
            </tr>
