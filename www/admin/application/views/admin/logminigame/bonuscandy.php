    ...
    <div class="wrapper">
        ...
        <div class="horControlB menu_action">
            <ul>
                ...
                <li>  <a href="<?php echo admin_url('logminigame/bonuscandy')?>" title="List" >
                        <img src="<?php echo public_url('admin')?>/images/icons/control/16/list.png">
                        <span>List lượt quay slot free</span>
                    </a></li>
            </ul>
        </div>
        <div class="clear"></div>
    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            ...
            <tr style="height: 20px;">
                ...
                <td>Amount of money thưởng tối đa</td>
            </tr>
            </thead>
            <tbody>
            <?php $i = 1;?>
