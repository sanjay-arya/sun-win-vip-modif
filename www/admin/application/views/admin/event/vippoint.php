        ...
        <div class="widget">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select id="txttype" name="txttype" style="margin-bottom:-2px;width: 160px">
                                    <option value="" <?php if($this->input->post('txttype') == ""){echo "selected";} ?>>Select</option>
                                    <option value="1" <?php if($this->input->post('txttype') == "1"){echo "selected";} ?>>Add vippoint event</option>
                                    <option value="2" <?php if($this->input->post('txttype') == "2"){echo "selected";} ?>>Except vippoint event</option>
                                    <option value="3" <?php if($this->input->post('txttype') == "3"){echo "selected";} ?>>Plus vin</option>
                                </select>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><label style="margin-left: 70px;margin-bottom:-2px;width: 100px">Account:</label></td>
            ...
            <div class="formRow">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <h5>Total number of records:<span style="color: #0000ff" id="sumrecord"></span></h5>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function resultSearchTransction(stt, nickname,value,status,isbot,date) {
        ...
        if(status == 1 ){
            rs += "<td>" + "Add vippoint event"+ "</td>";
        }else if(status == 2){
            rs += "<td>" + "Except vippoint event"+ "</td>";
        }else if(status == 3){
            rs += "<td>" + "Plus Win"+ "</td>";
        }
        if(isbot == 0){
            rs += "<td>" + "Regular account" + "</td>";
        }else if(isbot == 1){
            rs += "<td>" + "Bot accounts" + "</td>";
        }
        rs += "<td>" + date + "</td>";
        rs += "</tr>";
        return rs;
