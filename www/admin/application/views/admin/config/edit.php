...
<?php if ($admin_info->Status == "A"): ?>
    <div class="title">
        <h4>Edit config <span style="color: #0000FF"><?php echo $plat ?></span></h4>
    </div>
    ...
    <?php if ($plat == "ios" || $plat == "ad" || $plat == "web" || $plat == "wp"): ?>
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <input type="button" id="search_tran" value="Edit config" class="button blueB"
...
<div class="row">
    ...
    elseif ($plat == "billing"): ?>
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Phone card purchase rate:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratiomt" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Phone recharge rate:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtrationdt" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Bank transfer rate:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>Maximum redemption user/day:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtclu" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Maximum reward redemption system/day:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtcls" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Maximum card purchases/time:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Number of times you loaded your card incorrectly:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtnrf" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Security effective time (hours):</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtcashtb" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Maximum bank transfer:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>General agent:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtsuagent" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Level 1 agent refund rate:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratiore1" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Level 2 agent refund rate:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Smallest Win general agent:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtdl1smin" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Largest Win purchasing agent:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtdl1smax" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Minimum balance transferred by level 1 agent to total agent:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Normal - regular transfer rate:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratioch" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Normal transfer rate - dl1:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratio01" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Normal transfer rate - dl2:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Transfer rate dl1 - dl1:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratio11" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Transfer rate dl1 - dl2:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratio12" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Transfer rate dl1 - usually:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>dl2 transfer rate - usually:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratio20" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Transfer rate dl2 - dl2:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" id="txtratio22" class="form-control">
                </div>
                <div class="col-sm-1">
                    <label>Transfer rate dl2 - dl1:</label>
                </div>
                <div class="col-sm-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <select id="txtplatform" disabled="true">
                        ...
                        <option value="billing">Billing</option>
                        <option value="other">Other</option>
                        <option value="game_bai">Card game</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <select id="txtplatform" disabled="true">
                        ...
                        <option value="other">Other</option>
                        <option value="i2b">I2b</option>
                        <option value="nganluong">Money</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    elseif ($plat == "admin"): ?>
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Number of level 2 agents:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtnumberdl2">
                </div>
                <div class="col-sm-1">
                    <label>Win giftcode face value:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtgiftcodevin">
                </div>
                <div class="col-sm-1">
                    <label>Coin giftcode face value:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>Number of minigame giftcode spins:</label>
                </div>
                <div class="col-sm-2">
    ...
    <?php
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>Email activation URL:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>The card game is running:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtlistgb">
                </div>
                <div class="col-sm-1">
                    <label>Warning phone number:</label>
                </div>
                <div class="col-sm-2">
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.errorCode == 0) {
                        ...
                        $("#message").html("You updated the data successfully!!")
                    } else {
                        $("#message").html("You failed to update data!!")
                    }
