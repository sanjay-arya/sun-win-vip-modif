...
<?php else: ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                <h6>God of Fortune slot game</h6>
            ...
            <form class="list_filter form" action="<?php echo admin_url('loggameslot/thantai') ?>" method="post">
                <div class="formRow">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('loggameslot/thantai') ?>'; "
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggameslot/thantaiajax')?>",
            data: {
