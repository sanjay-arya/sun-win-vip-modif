...
<?php else: ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <form class="list_filter form" action="<?php echo admin_url('loggameslot/pokemon') ?>" method="post">
                <div class="formRow">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset"
                                       onclick="window.location.href = '<?php echo admin_url('loggameslot/pokemon') ?>'; "
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('loggameslot/pokemonajax')?>",
            data: {
