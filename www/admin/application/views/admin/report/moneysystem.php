...
<div class="wrapper">
    ...
    <div class="title">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-3">
                    <h5>Money sự kiện: <span id = "spanevent" style="color: #0000ff"></span></h5>
                </div>
                <div class="col-sm-3">
        ...
        <div class="formRow">
            <div class="row">
                <h4 id="" style="color: red;margin-left: 20px">Card game</h4>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="title">
            <h6>Total money hiện tại trong hệ thống</h6>
        </div>
        <div class="formRow">
            <div class="row">
                <div class="col-xs-12">
            ...
            success: function (res) {
                ...
                if (res.actionGame == null || res.actionGame == "" ) {
                    $("#resultsearch").html("");
                        ...
                        var stt = 1;
                        result1 += resultSearchTransction(stt, "Over/under", res.actionGame.TaiXiu.moneyWin, res.actionGame.TaiXiu.moneyLost, res.actionGame.TaiXiu.moneyOther, res.actionGame.TaiXiu.fee, res.actionGame.TaiXiu.revenuePlayGame, res.actionGame.TaiXiu.revenue);
                    ...
                    if(res.actionGame.Sam != null) {
                        var stt = 1;
                        result11 += resultSearchTransctionbai(stt, "Sam", res.actionGame.Sam.moneyWin, res.actionGame.Sam.moneyLost, res.actionGame.Sam.moneyOther, res.actionGame.Sam.fee, res.actionGame.Sam.revenuePlayGame, res.actionGame.Sam.revenue);
                    ...
                    if(res.actionGame.Lieng != null) {
                        var stt = 6;
                        result11 += resultSearchTransctionbai(stt, "Lieng", res.actionGame.Lieng.moneyWin, res.actionGame.Lieng.moneyLost, res.actionGame.Lieng.moneyOther, res.actionGame.Lieng.fee, res.actionGame.Lieng.revenuePlayGame, res.actionGame.Lieng.revenue);
                        $('#logactiongamebai').html(result11);
                    }
                ...
                if (res.actionGameBot == null || res.actionGameBot == "") {
                    ...
                    if(res.actionGameBot.TaiXiu != null) {
                        var stt = 1;
                        result3 += resultSearchTransctionbot(stt, "Over/under", res.actionGameBot.TaiXiu.moneyWin, res.actionGameBot.TaiXiu.moneyLost, res.actionGameBot.TaiXiu.moneyOther, res.actionGameBot.TaiXiu.fee, res.actionGameBot.TaiXiu.revenuePlayGame, res.actionGameBot.TaiXiu.revenue);
                    ...
                    if(res.actionGameBot.Sam != null) {
                        var stt = 1;
                        result33 += resultSearchTransctionbotbai(stt, "Sam", res.actionGameBot.Sam.moneyWin, res.actionGameBot.Sam.moneyLost, res.actionGameBot.Sam.moneyOther, res.actionGameBot.Sam.fee, res.actionGameBot.Sam.revenuePlayGame, res.actionGameBot.Sam.revenue);
                    ...
                    if(res.actionGameBot.Lieng != null) {
                        var stt = 6;
                        result33 += resultSearchTransctionbotbai(stt, "Lieng", res.actionGameBot.Lieng.moneyWin, res.actionGameBot.Lieng.moneyLost, res.actionGameBot.Lieng.moneyOther, res.actionGameBot.Lieng.fee, res.actionGameBot.Lieng.revenuePlayGame, res.actionGameBot.Lieng.revenue);
                        $('#logactionbotgamebai').html(result33);
                    }
