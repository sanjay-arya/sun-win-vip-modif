...
<!--                    <table>-->
<!--                        <tr>-->
<!--                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Trading code:</label></td>-->
...
<!--                        <tr>-->
<!---->
<!--                            <td><label style="margin-left: 28px;margin-bottom:-2px;width: 100px">Status:</label></td>-->
<!--                            <td class="">-->
...
<!--                                    <option value="1" --><?php //if($this->input->post('select_status') == "1" ){echo "selected";} ?><!-->Failure</option>-->
