        ...
        <?php endif; ?>            <div class="title">
            ...
            <form class="list_filter form" action="<?php echo admin_url('report/exportbycard') ?>" method="post">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Denominations:</label>
                            </td>
                            <td class="">
                            ...
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Name bảng:</label>
                            </td>
                            <td class="">
