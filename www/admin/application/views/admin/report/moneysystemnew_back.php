                    ...
                    <table id="checkAll" class="table table-bordered" style="table-layout: fixed">
                        <thead>
                            <tr style="height: 20px;">
                                <td>Money loaded</td>
                                <td>Money sự kiên</td>
                                <td style="font-weight: 600;color: #7a6fbe">Total nạp</td>
                                <td>Money đổi thưởng</td>
                                <td>Money lệch đại lý</td>
                                <!--                        <td>Money lệch user</td>-->
                                <td style="font-weight: 600;color: #7a6fbe">Total đổi thưởng</td>
        ...
        <div class="container">
            <div id="tabs-container">
                <ul class="tabs-menu">
                    ...
                    <li><a href="#tab-2">Money vào game</a></li>
                    <li><a href="#tab-3">Money ra game</a></li>
                    <li><a href="#tab-4">Money khác</a></li>
                ...
                <div class="tab row">
                    <div id="tab-1" class="tab-content col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <h4 id="" style="color: #e72929;margin-left: 10px">Card game</h4>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <table id="checkAll1" class="table table-bordered" style="table-layout: fixed">
                                    <thead>
                                        <tr style="height: 20px;">
                                            <td>Name game</td>
                                            <td>Money Vin đổi sang</td>
                                            <td>Money đổi sang Vin</td>
                                            <td>Money hoàn trả</td>
                                            <td>Money sự kiện</td>
                                            <td>Waste</td>
                                            <td class="col-sm-2">Money wins trong game</td>
                            ...
                            <div class="col-sm-12">
                                <h4 id="" style="color: #e72929;margin-left: 10px">Total</h4>
                            </div>
                            <div class="col-sm-12">
                                <table id="checkAll" class="table table-bordered" style="table-layout: fixed">
                                    <tbody>
                            ...
                            <div class="col-sm-12">
                                <table id="checkAll" class="table table-bordered" style="table-layout: fixed">
                                    ...
                                    <tr>
                                        ...
                                        <td>Money loaded từ VTC</td>
                                        <td id="money444" class="moneyhtml"></td>
                                    </tr>
                                    <tr>

                                        <td style="color: #7a6fbe;font-weight: 600">Total</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Redeem vippoint rewards</td>
                                        <td id="money17" class="moneyhtml"></td>
                                    </tr>
                                    <tr>

                                        <td>Refund of agent fees</td>
                                        <td id="money18" class="moneyhtml"></td>
                                    </tr>
                                    <tr>
                                        <td>Sales bonus đại lý</td>
                            ...
                            <div class="col-sm-12">
                                <table id="checkAll" class="table table-bordered" style="table-layout: fixed">
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #7a6fbe;font-weight: 600">Money lệch</td>
                    ...
                    <div id="tab-5" class="tab-content col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 id="" style="color: #e72929;margin-left: 10px">Money bot</h4>
                            </div>
                            <div class="col-sm-12">
                                <table id="checkAll" class="table table-bordered" style="table-layout: fixed">
                                    <thead>
                                        <tr style="height: 20px;">
                                            <td>Add deduct money bot</td>
                                            <td>Admin</td>
                                            <td>Vippoint event</td>
                                        </tr>
                                        <tr style="height: 20px;">
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res.taiXiu != null || res.taiXiu != "") {
                result2 += resultSearchTransctiontaixiu("Over/under", res.taiXiu.moneyWin, res.taiXiu
                ...
                result2 += resultSearchTransction("Over/under", 0, 0, 0, 0, 0, 0);
                $('#logaction1').html(result2);
            }
            ...
            if (res.actionGame != null || res.actionGame != "") {
                ...
                if (res.actionGame.BauCua != null) {
                    result2 += resultSearchTransction("Election crab", res.actionGame.BauCua.moneyWin, res
                    ...
                    result2 += resultSearchTransction("Election crab", 0, 0, 0, 0, 0, 0);
                    $('#logaction1').html(result2);
                }
                ...
                if (res.actionGame.Sam != null) {
                    result3 += resultSearchTransction("Sam", res.actionGame.Sam.moneyWin, res
                    ...
                    result3 += resultSearchTransction("Sam", 0, 0, 0, 0, 0, 0);
                    $('#logaction2').html(result3);
                }
                ...
                if (res.actionGame.Tlmn != null) {
                    ...
                    result3 += resultSearchTransction("Head south", 0, 0, 0, 0, 0, 0);
                    $('#logaction2').html(result3);
                }
                ...
                //                }  else{
                //                    result3 += resultSearchTransction("Disturbance", 0, 0, 0, 0,0, 0);
                //                    $('#logaction2').html(result3);
                //                }
                if (res.actionGame.Lieng != null) {

                    result3 += resultSearchTransction("Lieng", res.actionGame.Lieng.moneyWin, res
                    ...
                    result3 += resultSearchTransction("Lieng", 0, 0, 0, 0, 0, 0);
                    $('#logaction2').html(result3);
                }
                ...
                if (res.actionGame.BaiCao != null) {
                    ...
                    result3 += resultSearchTransction("Scratch cards", 0, 0, 0, 0, 0, 0);
                    $('#logaction2').html(result3);
                }
            ...
            if (res.taiXiuBot != null || res.taiXiuBot != "") {
                result22 += resultSearchTransctiontaixiu("Over/under", res.taiXiuBot.moneyWin, res
                ...
                result22 += resultSearchTransction("Over/under", 0, 0, 0, 0, 0, 0);
                $('#logactionbot1').html(result22);
            }
            ...
            if (res.actionGameBot != null || res.actionGameBot != "") {
                ...
                if (res.actionGameBot.BauCua != null) {
                    result22 += resultSearchTransction("Election crab", res.actionGameBot.BauCua.moneyWin,
                    ...
                    result22 += resultSearchTransction("Election crab", 0, 0, 0, 0, 0, 0);
                    $('#logactionbot1').html(result22);
                }
                ...
                if (res.actionGameBot.Sam != null) {
                    result33 += resultSearchTransction("Sam", res.actionGameBot.Sam.moneyWin, res
                    ...
                    result33 += resultSearchTransction("Sam", 0, 0, 0, 0, 0, 0);
                    $('#logactionbot2').html(result33);
                }
                ...
                if (res.actionGameBot.Tlmn != null) {
                    ...
                    result33 += resultSearchTransction("Head south", 0, 0, 0, 0, 0, 0);
                    $('#logactionbot2').html(result33);
                }
                //                if(res.actionGame.TaLa != null) {
                //                    result3 += resultSearchTransction("Tá Lả", res.actionGame.TaLa.moneyWin, res.actionGame.TaLa.moneyLost, res.actionGame.TaLa.moneyOther, res.actionGame.TaLa.fee, res.actionGame.TaLa.revenuePlayGame, res.actionGame.TaLa.revenue);
                ...
                if (res.actionGameBot.Lieng != null) {
                    ...
                    result33 += resultSearchTransction("Lieng", res.actionGameBot.Lieng.moneyWin,
                    ...
                    result33 += resultSearchTransction("Lieng", 0, 0, 0, 0, 0, 0);
                    $('#logactionbot2').html(result33);
                }
                ...
                //                }
                //                else{
                //                    result3 += resultSearchTransction("Poker element", 0, 0, 0, 0,0, 0);
                //                    $('#logaction2').html(result3);
                //                }
                if (res.actionGameBot.BaiCao != null) {
                    ...
                    result33 += resultSearchTransction("Scratch cards", 0, 0, 0, 0, 0, 0);
                    $('#logactionbot2').html(result33);
                }
