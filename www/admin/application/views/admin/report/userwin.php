    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                ...
                <h6 class="total">Total cược:<span class="total-number" style="color:#0000ff" id="totalBet"></span></h6>
                <h6 class="total">Total phế:<span class="total-number" style="color:#0000ff" id="totalFee"></span></h6>
                <h6 class="total">Total vòng cược:<span class="total-number" id="totalSoVongcuoc"></span></h6>
            </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select class="money-type-2" style="margin-left: 1px; width: 219px!important;" id="actionName" name="actionName">
                                    ...
                                    <option value="BaCay" <?php if($this->input->post('actionName') == "BaCay"){echo "selected";} ?>>Card game ba cây</option>
