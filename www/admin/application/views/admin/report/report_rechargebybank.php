...
<div class="wrapper">
    ...
    <div class="widget">
        ...
        <div class="title">
            <h6>Quản lý tài khoản ngân hàng</h6>
        </div>
        <form class="list_filter form" action="<?php echo admin_url('report/report_rechargebybank') ?>" method="post">
            <div class="formRow">
                <table>
                    <tr>
                        <td>
            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Bank:</label></td>
            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="reset"
                                   onclick="window.location.href = '<?php echo admin_url('report/report_rechargebybank') ?>'; "
...
<script>
    ...
    function resultSearchTransction(stt,tid, nickname, money, bank,ip, status,description,time,updatetime, userApprove) {
        ...
        rs += '<td>';
        rs += "<a class=\"label label-danger label_" + tid + "\" href=\"javascript: getProviders(" + tid + ")\">Select</a>"
    ...
    function getProviders(orderId) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('report/rechargebybank/rechargeajax')?>",
            data: {
