    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <form class="list_filter form" style="margin-bottom: 20px;"
                  action="<?php echo admin_url('report/cardwithdraw') ?>" method="post">
                <div class="formRow">
...
<script>
    ...
    function payTransaction() {
        if ($("#title-trans-name").text().includes("huỷ")) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo admin_url('report/cancelCardTransaction')?>",
                dataType: 'json',
                data: data,
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo admin_url('report/confirmCardTransaction')?>",
                dataType: 'json',
                data: data,
                success: function (result) {
                    $('#spinner').hide();
