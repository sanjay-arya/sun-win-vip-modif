...
<?php else: ?>
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                <h6>List Deposit</h6>
                <h6 style="float: right">Total giao dich:<span style="color:#0000ff" id="total_trans"></span></h6>
                <h6 style="float: right">Total số tiền:<span style="color:#0000ff" id="total_money"></span></h6>
                <h6 style="float: right">Total thành công:<span style="color:#0000ff" id="total_success"></span></h6>
