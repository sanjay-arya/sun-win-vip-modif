...
<!--                <h6>Momo rút tiền</h6>-->
<!--            </div>-->
<!--            <form class="list_filter form" style="margin-bottom: 20px;"-->
<!--                  action="--><?php //echo admin_url('report/momowithdraw') ?><!--" method="post">-->
<!--                <div class="formRow">-->
...
<!--                                       id="nick_name" value="--><?php //echo $this->input->post('nick_name') ?><!--"-->
<!--                                       name="nick_name"></td>-->
<!--                            <td><label style="margin-left: 30px;margin-bottom:-2px;width: 100px">Status: </label>-->
<!--                            </td>-->
...
<!--            $.ajax({-->
<!--                type: "POST",-->
<!--                url: "--><?php //echo admin_url('report/cancelMomoTransaction')?>//",
//                dataType: 'json',
//                data: data,
...
//            $.ajax({
//                type: "POST",
//                url: "<?php //echo admin_url('report/confirmMomoTransaction')?>//",
//                dataType: 'json',
//                data: data,
//                success: function (result) {
//                    $('#spinner').hide();
