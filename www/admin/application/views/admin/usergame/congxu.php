...
<!--                        <div class="col-sm-2">-->
<!--                        </div>-->
<!--                        <div class="col-sm-2"><label>Money xu</label></div>-->
...
<!--                        <div class="col-sm-1"><input class="form-control" id="txtotp"  type="text" placeholder="Enter OTP"></div>-->
<!--                        <div class="col-sm-1">-->
...
<!--                            <p style="color: #0000ff">Bạn Add xu thành công</p>-->
<!--                        </div>-->
...
<!--        if($("#filter_iname").val() == ""){-->
<!--            $("#errorname").html("You have not entered a nickname");-->
<!--            return false;-->
<!--        }-->
<!--        if($("#txtmoney").val() == ""){-->
