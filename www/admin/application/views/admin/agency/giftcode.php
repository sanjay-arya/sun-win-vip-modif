...
<div class="wrapper">
    <div class="widget">
        ...
        <div class="formRow">
            <form class="list_filter form" action="<?php echo admin_url('giftcode') ?>" method="get">
                <table>
                    <tr>
                        <td><label  id = "labelvin" style="margin-left: 30px;margin-bottom:-2px;width: 70px;">Denominations</label></td>
                        ...
                        <td><label  id = "labelxu" style="margin-left: 30px;margin-bottom:-2px;width: 70px;display: none">Denominations</label></td>
                        <td><select id="menhgiaxu" name="menhgiaxu"
                                ...
                                <option value="10">10M Coin</option>
                            </select></td>
                        <input type="hidden" value="<?php echo $source ?>" id="nguonxuat">
                        ...
                        <td>
                            <input type="reset"
                                   onclick="window.location.href = '<?php echo admin_url('giftcode') ?>'; "
