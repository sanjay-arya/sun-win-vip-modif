<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
            <h5>History of money transfer and receipt</h5>
        </div>
        <div class="clear"></div>
    </div>
</div>
                    ...
                    <form class="list_filter form" action="<?php echo admin_url('agency/listtranfer') ?>" method="get">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="..." class="label"><label for="filter_id"></label></td>
                                <td style="..." class="label"><label for="filter_id">Money transfer account</label></td>
                                <td style="..." class="item"><input type="text" style="width:155px;" id="filter_iname" value="<?php echo $this->input->get('name') ?>" name="name"></td>
                                <td style="..." class="label"><label for="filter_id">Receiving account</label></td>
                                ...
                                <td class="label" style="width:60px;"><label for="filter_created">Since</label></td>
                                <td class="item"><input name="created" value="<?php echo $this->input->get('created') ?>" id="toDate" type="text" class="datepicker"/></td>
                                <td class="label"><label for="filter_created_to">To date</label></td>
