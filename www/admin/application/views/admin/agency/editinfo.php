...
<div class="wrapper">
    <div class="widget">
        <div class="title">
            <h6>Update agent information</h6>
        </div>
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
            <fieldset>
                ...
                <div class="formRow">
                    <label for="param_username" class="formLeft">Name of agent:<span class="req">*</span></label>
                    <div class="formRight">
                ...
                <div class="formRow">
                    <label for="param_username" class="formLeft">Address:<span class="req">*</span></label>
                    <div class="formRight">
                ...
                <div class="formRow">
                    <label for="param_username" class="formLeft">Phone:<span class="req">*</span></label>
                    <div class="formRight">
