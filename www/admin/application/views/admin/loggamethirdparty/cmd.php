    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                ...
                <h6 class="total d-none">Total Số People chơi:<span class="total-number" id="tong_player"></span></h6>
            </div>
                ...
                <div class="formRow row">
                    ...
                    <div class="col-sm-2">
                        <select id="fgt" name="fgt">
                            <option value="0" <?= ($this->input->post('fgt') == 0 || $this->input->get('fgt') == 0) ? 'selected' : '' ?>>Select</option>
