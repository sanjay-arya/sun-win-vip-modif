...
<?php else: ?>
    <section class="content-header">
        <h1>
            List giftcode đã xuất cho vận hành
        </h1>
    </section>
                        ...
                        <form action="<?php echo admin_url('giftcodevh/giftcodevhuse') ?>" method="post">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <label id="labelvin" class="col-sm-1 control-label">Denominations Win</label>
                                    ...
                                    <label id="labelvin" class="col-sm-1 control-label">Denominations xu</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label id="labelvin" class="col-sm-1 control-label">Display</label>
                        ...
                        <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <label id="labelvin" class="col-sm-1 control-label">Status</label>
