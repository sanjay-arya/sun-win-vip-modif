        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form action="<?php echo admin_url("giftcodevh/delgiftcodevh") ?>" id="fileinfo" name="fileinfo"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <label class="col-sm-2 control-label" for="exampleInputEmail1">Money</label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <label id="labelvin" class="col-sm-2 control-label">Denominations</label>

                            <div class="col-sm-2" id="menhgiavin">
                                <select name="menhgiavin" class="form-control" id="roomvin">
                                    <?php foreach($listvin as $key => $row): ?>
                                        <option value="<?php echo $row ?>"><?php echo $row.",000 Zik" ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-sm-2" id="menhgiaxu" style="display: none">
                                <select name="menhgiaxu" class="form-control" id="roomxu">
                                    <?php foreach($listxu as $key => $row): ?>
                                        <option value="<?php echo $row ?>"><?php echo $row.",000,000 Coin" ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    $("#search_tran").click(function () {
        ...
        if ($("#listgiftcode").val()== "" ) {
            ...
            if ($("#money").val() == 1) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo admin_url('giftcodevh/delgiftcodevhajax')?>",
                    data: {
