...
<section class="content-header">
    <h1>
        Giftcode statistics trong kho vận hành
    </h1>
</section>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <label id="labelvin" class="col-sm-1 control-label">Denominations</label>
                            ...
                            <div class="col-sm-2" id="menhgiaxu" style="display: none">
                                <select name="menhgiaxu" class="form-control" id="roomxu">
                                    ...
                                    <?php foreach($listxu as $key => $row): ?>
                                        <option value="<?php echo $row ?>"><?php echo $row."M Coin" ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                         class="btn btn-primary pull-left" id="reset"  onclick="window.location.href = '<?php echo admin_url('giftcodevh/giftcodeusevanhanh') ?>'; "></div>
                            </div>
                        </div>
                    <div class="col-sm-12">
...
<script>
    ...
    $("#search_tran").click(function () {
        ...
        if($("#money").val()==1){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo admin_url("giftcodevh/giftcodeusevanhanhajax") ?>",
                data: {
                    roomvin: $("#roomvin").val(),
