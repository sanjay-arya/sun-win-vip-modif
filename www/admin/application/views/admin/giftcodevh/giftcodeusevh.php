...
<section class="content-header">
    <h1>
        Giftcode statistics đã xuất cho vận hành
    </h1>
</section>
                        ...
                        <div class="form-group">
                            ...
                            <span class="glyphicon glyphicon-calendar"></span>
                                ...
                                <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                             ...
                                                             onclick="window.location.href = '<?php echo admin_url('giftcodevh/giftcodeusevh') ?>'; ">
                                </div>
                            </div>
                        </div>
                    <div class="col-sm-12">
...
<style>
    ...
    function giftcodexu(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url("user/reportgcajax") ?>",
            data: {
                roomvin: $("#roomvin").val(),
