    ...
    <!--                            <p style="color: #0000ff">Bạn send mail thành công</p>-->
    <!--                        </div>-->
    ...
    //                        $("#errocode").html("Quantity nickname và số lượng giftcode không bằng nhau vui lòng upload lại file");
    //
    //
    //                    }
    ...
    //                }, error: function () {
    //                    $("#spinner").hide();
    //                    $("#errocode").html("Bạn không send tin nhắn gift code");
    //                }
    //            });
    //        }
    //
