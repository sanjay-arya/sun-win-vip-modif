            ...
            <div class="col-xs-12">
                <form class="box">
                    <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3" style="padding-left: 0;">
                                    <select class="form-control" id="inputType" name="Type">
                                        <option value="0">Type 0: Used for that same user, only used once</option>
                                        <option value="1">Type 1: Used for all users, each user can use it once</option>
                                        <option value="2">Type 2: Any user can use it, only once</option>
                                        <option value="3" selected>Type 3: A user can only use 1 Giftcode in the event, the gift code can be used maximum 1 time
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div id="showForType0or3" class="form-group">
                            <div class="row">
                                <div class="col-sm-2"></div>
                                ...
                                <div class="col-sm-3" style="padding-left: 0;">
                                    <select id="inputEvent" name="inputEvent" class="form-control my-input-class">
                                        ...
                                        <?php foreach($eventConfig as $item) { ?>
...
<script>
    $(document).ready(function (){
        ...
        let today = moment(new Date()).hours(23).minutes(59).seconds(59).milliseconds(59).subtract(2, 'day')
    ...
    function showOrHideInput() {
        ...
        switch (type) {
            case "0":
                ...
                $("#showForType0").show()
                $("#showForType1").hide()
                $("#showForType0or3").show()
                break
            case "1":
                $("#hideForType0").show()
                $("#showForType0").hide()
                $("#showForType1").show()
                $("#showForType0or3").hide()
                break
            case "2":
                $("#hideForType0").show()
                $("#showForType0").hide()
    ...
    $("#search_tran").click(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('giftcodes/addgiftcodeajax') ?>",
            data: {
