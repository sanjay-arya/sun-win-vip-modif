...
'chuy'=>'<font color="red"><b>Chú ý</b>:<br/>
					+ Name, mật khẩu phân biệt chữ hoa/thường.<br/>
...
'huongdancaidat'=>'Thông tin cần phải biết:<br/>
	<ul>- Bỏ trống Name truy cập và mật khẩu thì ai cũng có thể đăng nhập.</ul>
	<ul>- Name truy cập và tên nick phân biệt Hoa/Often.</ul>
	...
	<ul>- Time truy cập an toàn là Time dùng để chặn một ai đó cố gắng đăng nhập vào hệ thống.</ul>
...
'ntaikhoan'=>'Account mới',
'nmatkhau'=>'A new password',
