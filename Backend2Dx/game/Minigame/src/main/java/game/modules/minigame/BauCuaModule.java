...
//    private final Runnable rewardToiChonCaTask = new RewardToiChonCaTask();
    ...
    public void init() {
        super.init();
        this.loadData();
        this.rooms.put("BauCua_vin_10", new MGRoomBauCua("BauCua_vin_10", 10, (byte)1, (byte)0, this.funds[0]));
        this.rooms.put("BauCua_vin_100", new MGRoomBauCua("BauCua_vin_100", 100, (byte)1, (byte)1, this.funds[1]));
        this.rooms.put("BauCua_vin_1000", new MGRoomBauCua("BauCua_vin_1000", 1000, (byte)1, (byte)2, this.funds[2]));
        this.rooms.put("BauCua_xu_100", new MGRoomBauCua("BauCua_xu_100", 100, (byte)0, (byte)3, this.funds[3]));
        this.rooms.put("BauCua_xu_1000", new MGRoomBauCua("BauCua_xu_1000", 1000, (byte)0, (byte)4, this.funds[4]));
        this.rooms.put("BauCua_xu_10000", new MGRoomBauCua("BauCua_xu_10000", 10000, (byte)0, (byte)5, this.funds[5]));
