...
public class LoggerConfig {
   ...
   public static final String KETTHUC = "HC<";
   ...
   public static final String DANHBIEN = "DB<";
   public static final String KECUA = "KC<";
   public static final String SELECT_DEALER = "SD<";
   public static final String TAKE_TURN = "DQ<";
   public static final String NEW_ROUND = "NR<";
   public static final String PUBLIC_CARD = "PC<";
}
