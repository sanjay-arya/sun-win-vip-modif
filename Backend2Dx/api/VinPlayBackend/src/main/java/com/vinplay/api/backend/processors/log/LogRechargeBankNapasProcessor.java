...
implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        LogRechargeBankNapasResponse res = new LogRechargeBankNapasResponse(false, "1001");
        try {
            ...
            if (nickname != null && bank != null && transId != null && ip != null && transNo != null && status != null && endTime != null && pages != null) {
                ...
                res = dao.getLogNapas(nickname, bank, transId, ip, transNo, status, startTime, endTime, page);
            }
        }
        catch (Exception e) {
