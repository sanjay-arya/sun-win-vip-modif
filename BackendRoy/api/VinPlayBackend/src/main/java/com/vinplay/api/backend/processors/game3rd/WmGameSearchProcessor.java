...
public class WmGameSearchProcessor implements BaseProcessor<HttpServletRequest, String> {
	private static final Logger logger = Logger.getLogger(WmGameSearchProcessor.class);
	...
	public String execute(Param<HttpServletRequest> param) {
		...
		try {
			// TODO: Check role
			ThirdPartyResponse<List<WMGameRecordItem>> res = null;
					if (res != null) {
